...
import { UPDATE_WORKING_GROUP, FETCH_WORKING_GROUPS_BY_ID } from '../../graphql/workingGroups';
  ...
  render() {
    ...
    return (
      <div className="has-box-shadow editor">
        ...
        {!edit && <div dangerouslySetInnerHTML={{ __html: methodology || this.props.selectedWorkingGroup.methodology }}></div>}
      </div>
    )
  }
