...
// -------- ASSETS & STYLES ------------
import { TitleH1, Text, TitleH3, Flex } from "../../styles";
          ...
          <Flex>
            ...
            <div className="btn-group">
              <Link
                ...
                className="transparent small edit-btn"
              >
                <img src={iconEdit} alt="Profile" /> {t("Edit")}
              </Link>
            </div>
          </Flex>
              ...
              <div>
                {groups.map((group, index) => (
                  <p className="info-wrapper" key={group.id}>
                    <Link to={`/working-group/${groupTitleToUrl(group.title)}`}>
                      {group.title}
                    </Link>
                  </p>
                ))}
