...
const chartData = [
  {
    name: 2017, value: 0, color: '#527BDD',
  },
  {
    name: 2018, value: 0, color: '#F4D581',
  },
  {
    name: 2019, value: 0, color: '#F4C9D9',
  },
  {
    name: 2020, value: 0, color: '#E5E7EF',
  },
];
...
class Compare extends PureComponent {
  render() {
    ...
    return (
      <CountryPage>
        <TitleH1 margin="0 0 30px">{t('Historical data')} {constants.defaultCountry.name}</TitleH1>
        <Row className="graph-wrapper empty">
          ...
          <Col span={24} lg={12} className="col-3 border-right">
            <TitleH3>{t("Reliability of supply and transparency of tariff index (0-8) Historical")}</TitleH3>
