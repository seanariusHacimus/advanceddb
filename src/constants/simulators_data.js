export default {
  starting_a_business: {
    ...
    ease_of_starting_rank: {
      ...
      value: 146,
      description: 'The score for starting a business is the simple average of the scores for each of the component indicators: the procedures, time and cost for an entrepreneur to start and formally operate a business, as well as the paid-in minimum capital requirement. '
    },
    time_men: {
      order: 4,
      title: "Time - Men (days)",
      value: 36,
      description: "The time for men captures the median duration that business incorporation experts indicate is necessary for five male married entrepreneurs to complete all procedures required to start and operate a business with minimum follow- up and no extra payments.It is calulared in calendar days.The time estimates of all procedures are added to calculate the total time required to start and operate a business, taking into account simultaneity of processes.It is assumed that the minimum time required for each procedure is one day, except for procedures that can be fully completed online, for which the time required is recorded as half a day."
    },
    time_women: {
      order: 7,
      title: "Time - Women (days)",
      value: 36,
      description: 'The time for women captures the median duration that business incorporation experts indicate is necessary for five female married entrepreneurs to complete all procedures required to start and operate a business with minimum follow-up and no extra payments. It is calulared in calendar days. The time estimates of all procedures are added to calculate the total time required to start and operate a business, taking into account simultaneity of processes. It is assumed that the minimum time required for each procedure is one day, except for procedures that can be fully completed online, for which the time required is recorded as half a day.'
    }
  },
  dealing_with_construction_permits: {
    ...
    ease_of_construction_rank: {
      ...
      value: 120,
      description: 'The ranking of economies on the ease of dealing with construction permits is determined by sorting their scores for dealing with construction permits. '
    },
    procedures: {
      order: 3,
      title: "Procedures (number)",
      value: 12,
      description: 'The number of procedures records all interactions of the building company’s employees or any party acting on its behalf with external parties, including government agencies, notaries, the land registry, the cadastre, utility companies and public inspectors. Procedures that the company undergoes to connect the warehouse to water and sewerage are included. All procedures that are legally required and that are done in practice by a majority of companies  are counted, even if they may be avoided in exceptional cases.'
    },
  ...
  registering_property: {
    ...
    ease_of_property_rank: {
      ...
      value: 167,
      description: 'The ranking of economies on the ease of registering property is determined by sorting their scores for registering property. '
    },
    procedures: {
      order: 3,
      title: "Procedures (number)",
      value: 6,
      description: 'The number of procedures records all the procedures necessary for a business (the buyer) to purchase a property from another business (the seller) and to transfer the property title to the buyer’s name so that the buyer can use the property for expanding its business, use the property as collateral in taking new loans or, if necessary, sell the property to another business. A procedure is defined as any interaction that is legally or in practice required between the buyer, the seller or their agents (if required) and external parties, including government agencies, inspectors, notaries and lawyers.'
    },
    quality_of_land_administration_index: {
      order: 6,
      title: "Quality of land administration index (0-30)",
      value: 7,
      description: 'The quality of land administration index is the sum of the reliability of infrastructure, transparency of information, geographic coverage, land dispute resolution and equal access to property rights. The score is computed based on the methodology in the DB17-20 studies.'
    },
  ...
  getting_credit: {
    credit_information_index: {
      ...
      value: 0,
      description: "The depth of credit information index measures the coverage, scope and accessibility of credit information available through credit reporting service providers such as credit bureaus or credit registries. The index ranges from 0 to 8 based on the methodology in the DB15-20 studies."
    },
    ease_of_credit_rank: {
      order: 1,
      static: true,
      ...
      value: 185,
      description: 'The ranking of economies on the ease of getting credit is determined by sorting their scores for getting credit.'
    },
    legal_rights_index: {
      order: 5,
      title: "Strength of legal rights index (0-12)",
      value: 1,
      description: 'The strength of legal rights index measures whether certain features that facilitate lending exist within the appli­cable collateral and bankruptcy laws. The index ranges from 0 to 10 based on the methodology in the DB05-14 studies.'
    },
    ease_of_getting_credit_score: {
      ...
      value: 5.0,
      description: 'The score for getting credit benchmarks economies with respect to the regulatory best practice on the indicator set. The score is indicated on a scale from 0 to 100, where 0 represents the worst regulatory performance and 100 the best regulatory performance, and is computed based on the methodology in the DB15-20 studies.'
    },
  },
  protecting_minority_investors: {
    ...
    ease_of_protecting_minority_investors_rank: {
      ...
      value: 147,
      description: 'The ranking of economies on the strength of minority shareholder protections is determined by sorting their scores for protecting minority investors. '
    }
  },
  paying_taxes: {
    ease_of_taxes_rank: {
      ...
      value: 106,
      description: 'The ranking of economies on the ease of paying taxes is determined by sorting their scores for paying taxes. '
    },
    payments: {
      order: 4,
      title: "Payments (number)",
      value: 31,
      description: 'The tax payments capture the total number of taxes and contributions paid, the method of payment, the frequency of payment, and the frequency of ﬁling. It includes taxes withheld by the company, such as sales tax, VAT and employee-borne labor taxes.'
    },
    postfiling_index: {
      order: 3,
      static: true,
      ...
      value: 95.0,
      description: 'The score for postfiling index benchmarks economies with respect to the regulatory best practice on the indicator. The score is indicated on a scale from 0 to 100, where 0 represents the worst regulatory performance and 100 the best regulatory performance, and is computed based on the methodology in the DB17-20 studies.'
    },
    ease_of_paying_taxes_score: {
      ...
      value: 69.5,
      description: 'The score for paying taxes is the simple average of the scores for each of the component indicators, the payments, time and total tax and contribution rate for a company to comply with tax laws in an economy, as well as the postfiling procedures to request and process a VAT refund claim and to comply with and complete a corporate income tax correction. The score is computed based on the methodology in the DB17-20 studies.'
    },
    time: {
      order: 5,
      title: "Time (hours)",
      value: 287,
      description: 'The time to comply with tax laws measures the time taken to prepare, ﬁle and pay three major types of taxes and contributions: the corporate income tax, value added or sales tax and labor taxes, including payroll taxes and social contributions.'
    },
    time_to_complete_a_corporate_income_tax_audit: {
      order: 10,
      title: "Time to complete a corporate income tax audit (weeks)",
      value: 0,
      description: 'Time to complete a corporate income tax correction (weeks) (DB17-20 methodology) measures the time to complete a review by the tax authority including a formal tax audit if in 25% or more of cases, a company that voluntarily reports an error in its corporate income tax return and an underpayment of the tax due would be selected for additional review. The component indicator is computed based on the methodology in the DB17-20 studies.'
    },
    time_to_comply_with_corporate_income_tax_audit: {
      order: 9,
      title: "Time to comply with corporate income tax audit (hours)",
      value: 7,
      description: 'The time to comply with a corporate income tax correction measures the time spent preparing and submitting the correction, and the time spent preparing information for the tax officers, if, in 25% or more of cases, a company that voluntarily reports an error in its CIT return and an underpayment of the tax due would be selected for additional review. The component indicator is computed based on the methodology in the DB17-20 studies.'
    },
    time_to_comply_with_vat_refund: {
      ...
      value: 'NO VAT',
      description: 'The time to comply with VAT refund measures the time spent preparing and submitting the refund claim and the time spent preparing information for the tax officers, if, in 50% or more of cases, a company that requests a VAT cash refund arising from a capital purchase would be selected for an additional review. The component indicator is computed based on the methodology in the DB17-20 studies.'
    },
  ...
  trading_across_borders: {
    ...
    ease_of_trading_rank: {
      ...
      value: 174,
      description: 'The ranking of economies on the ease of trading across borders is determined by sorting their scores for trading across borders. '
    },
  ...
  enforcing_contracts: {
    cost: {
      ...
      title: "Cost (% of claim)",
      value: 44.4,
      description: 'The cost to enforce contracts is recorded as a percentage of the claim value, assumed to be equivalent to 200% of income per capita or $5,000, whichever is greater. Three types of costs are recorded: average attorney fees, court costs and enforcement costs. Bribes are not taken into account.'
    },
    ease_of_contracts_rank: {
      ...
      value: 186,
      description: 'The ranking of economies on the ease of enforcing contracts is determined by sorting their scores for enforcing contracts. '
    },
    quality_of_judicial_processes_index: {
      order: 5,
      title: "Quality of judicial processes index (0-18)",
      value: 5.5,
      description: 'The score for quality of judicial processes index benchmarks economies with respect to the regulatory best practice on the indicator. The score is indicated on a scale from 0 to 100, where 0 represents the worst regulatory performance and 100 the best regulatory performance, and is computed based on the methodology in the DB17-20 studies.'
    },
  ...
  resolving_insolvency: {
    ease_of_resolving_insolvency_rank: {
      ...
      value: 168,
      description: 'The ranking of economies on the ease of resolving insolvency is determined by sorting their scores for resolving insolvency. '
    },
    recovery_rate: {
      order: 3,
      title: "Recovery rate (cents on the dollar)",
      value: 0,
      description: 'The recovery rate is recorded as cents on the dollar recovered by secured creditors through judicial reorganization, liquidation or debt enforcement (foreclosure or receivership) proceedings. The calculation takes into account the outcome: whether the business emerges from the proceedings as a going concern or the assets are sold piecemeal.'
    },
