...
const chartData = [
  {
    name: 'completed', title: indicatorStatus.completed, value: 40, color: '#527BDD',
  },
  {
    name: 'ongoing', title: indicatorStatus.ongoing_within_deadline, value: 23, color: '#F4D581',
  },
  {
    name: 'ongoingPast', title: indicatorStatus.ongoing_past_deadline, value: 10, color: '#F4C9D9',
  },
  {
    name: 'notStarted', title: indicatorStatus.not_started, value: 27, color: '#E5E7EF',
  },
                  ...
                  chartData.map((item, index) => {
                    return (
                      <Col xs={12} lg={24} key={index}>
                        <ChartTitle>
                          <h3>
                            <span className="label" style={{ backgroundColor: item.color }}></span>
                            {item.title}
                          </h3>
                        </ChartTitle>
                      </Col>
