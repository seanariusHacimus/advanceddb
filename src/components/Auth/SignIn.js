...
import edbm from '../../assets/auth/edbm.png';
    ...
    <SignInPage>
      <Row style={{ flex: 1 }}>
          ...
          <div className="inner-container">
            ...
            <form action="" autoComplete="off" onSubmit={submitForm}>
              ...
              <InputWrapper className='has-messages' align='flex-end'>
                ...
                />
                <label htmlFor="" onClick={() => passwordRef.current.focus()}>{t("Password")}</label>
                <span
              ...
              <Flex jc="space-between" margin="-4px 0 28px">
                <div className="text-light">
                  ...
                  />
                  <span style={{ marginLeft: '5px' }} className="clickable" onClick={() => setRemember(!checkRef.current.checked)}>{t("Remember my entry")}</span>
                </div>
                <Link to="/forgot-password" className="link-light">{t("Forgot password?")}</Link>
              </Flex>
        ...
        <Col style={styles.backgroundImage} sm={24} lg={16} flex={5}>
          <img src={edbm} alt={t("EDBM")} style={styles.flag} id="flag" />
