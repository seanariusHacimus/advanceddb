export const TOPIC_DESCRIPTIONS = {
  "Business Entry": {
    description: `<p>The Business Entry topic measures the process of
...
required to register new domestic and foreign firms.</p><p> Each pillar is divided into categories—defined by common
...
for each subcategory, category, and pillar.</p><p> Detailed methodology is available in the Methodology
Handbook.</p>`,
  },
  "Business Location": {
    description: `<p>The Business Location topic measures three different
...
environmental sustainability and public safety.</p><p> Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
each of which may, in turn, have several components.
...
Handbook.</p>`,
  ...
  "Utility Services": {
    description: `<p>The Utility Services topic measures the effectiveness of
...
reliable service, safety, and environmental sustainability of
provision and use of utility services. The second pillar of
...
reliability of utility service supply.</p><p> Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
each of which may, in turn, have several components.
...
Handbook.</p>`,
  ...
  Labor: {
    description: `<p>The Labor topic measures good practices in employment
...
with their obligations and relevant safeguards. The second
pillar measures the adequacy of public services for labor,
assessing the de facto provision of social protection and
the institutional framework on which the labor market
and the enforcement of labor regulations depend. The
third pillar measures the operational efficiency of labor
regulations and public services in practice, assessing
...
Relevant points are assigned to each indicator and
subsequently aggregated to obtain the number of points
for each subcategory, category, and pillar.</p><p>
Detailed methodology is available in the Methodology
Handbook.</p>`,
  },
  "Financial Services": {
    description: `<p>The Financial Services topic measures four areas—
...
sharing; and (iii) e—payments usage and their efficiency.</p><p> Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
each of which may, in turn, have several components.
...
Handbook.</p>`,
  ...
  "International Trade": {
    description: `<p>The International Trade topic measures different aspects
...
international trade.</p><p> Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
each of which may, in turn, have several components.
...
Handbook.</p>`,
  ...
  Taxation: {
    description: `<p>The Taxation topic measures the quality of regulation,
...
regulations and public services.</p><p> Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
each of which may, in turn, have several components.
...
Handbook.</p>`,
  ...
  "Dispute Resolution": {
    description: `<p>The Dispute Resolution topic measures efficiency and
...
recognition and enforcement of decisions.</p><p>
Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
...
Handbook.</p>`,
  ...
  "Market Competition": {
    description: `<p>The Market Competition topic measures good practices
related to the enforcement of competition policy,
intellectual property rights and innovation policy, and
regulations that focus on improving competition and
innovation in markets where the government is a
purchaser of services or goods across the three different
pillars. The first pillar assesses the quality of regulations
that promote market competition, covering de jure
features of a regulatory framework that enable firms to
participate in fair market conditions and innovate, and
where firms can participate in open and competitive
government markets. The second pillar measures the
adequacy of public services that promote market
competition, thus assessing the de facto provision of
services that create an equal level playing field in markets,
and that foster and promote innovation. The third pillar
measures the operational efficiency in the
implementation of key services promoting market
competition (reflecting both the ease of compliance with
the regulatory framework and the effective provision of
public services directly relevant to firms that contribute in
practice to the promotion of market competition).</p><p>
Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
...
subsequently aggregated to obtain the number of points
for each subcategory, category, and pillar.</p><p>
Detailed methodology is available in the Methodology</p>`,
  },
  "Business Insolvency": {
    description: `<p>The Business Insolvency topic measures key features of
insolvency systems on a regulatory level. It also assesses
the institutional and operational infrastructure associated
with insolvency proceedings (judicial services), as well as
the operational efficiency of insolvency proceedings
across three different dimensions, here referred to as
pillars. The first pillar assesses the quality of regulation
pertaining to judicial insolvency proceedings — liquidation
and reorganization, covering de jure features of a
regulatory framework that are necessary for structured
debt resolution processes and effective creditor and
debtor regimes. The second pillar measures the quality of
institutional and operational infrastructure for judicial
insolvency proceedings, thus assessing the de facto
aspects of insolvency resolution mechanisms and the
infrastructure required to implement the legal framework
on insolvency. The third pillar measures the time and cost
required to resolve in—court liquidation and
reorganization proceedings.</p><p>
Each pillar is divided into categories—defined by common
features that inform the grouping into a particular
category—and each category is further divided into
subcategories. Each subcategory has several indicators,
