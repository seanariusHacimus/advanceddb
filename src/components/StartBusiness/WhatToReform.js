...
import { FETCH_WORKING_GROUPS_BY_ID, UPDATE_WORKING_GROUP } from '../../graphql/workingGroups';
      ...
      <div className="has-box-shadow editor">
        {
          ...
          && (
            <Flex>
              <Button
                style={{ width: 'auto', padding: '5px 10px', marginLeft: 'auto', marginBottom: 30 }}
...

        {
          ...
          <Suspense fallback={t("Loading...")}>
            <Editor advanced onChange={this.inputHandler} value={what_to_reform} height={500} />
            <ButtonPrimary
              className="small"
        ...
        {!edit && <div dangerouslySetInnerHTML={{ __html: what_to_reform }}></div>}
      </div>
    )
  }
...
const mapDispatchToProps = dispatch => bindActionCreators({ selectWorkingGroupAction }, dispatch);

export default connect(mapStateToProps, mapDispatchToProps)(withLocale(WhatToReform));
