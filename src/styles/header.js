...
export default styled(Layout)`
  aside.sidebar {
  width: ${props => window.location?.pathname?.includes('messaging') ? '0' : '266px !important'};
    max-width: ${props => window.location?.pathname?.includes('messaging') ? '0' : '266px !important'};
    min-width: ${props => window.location?.pathname?.includes('messaging') ? '0' : '266px !important'};
    z-index: 1050;
  }
...
.is-assigned-group {
  ...
  .ant-layout-header {
      ...
      padding-left: ${props => window.location?.pathname?.includes('messaging') ? '0' : '265px !important'};
  ...
  @media screen and (max-width: 991px) {
      ...
      aside.ant-layout-sider-collapsed.ant-layout-sider-zero-width+section>header {
