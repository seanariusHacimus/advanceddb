export default {
  ...
  financial_services: {
    credit_information_index: {
      ...
      value: 0,
      description:
        "The depth of credit information index measures the coverage, scope and accessibility of credit information available through credit reporting service providers such as credit bureaus or credit registries. The index ranges from 0 to 8 based on the methodology in the DB15-20 studies.",
    },
    ease_of_credit_rank: {
      order: 1,
      static: true,
